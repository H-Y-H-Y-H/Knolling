...
class DiffusionModel(nn.Module):
    def __init__(self, latent_dim=32, hidden_dim=512, label_num=12):
        ...
        self.conv3 = nn.Conv2d(hidden_dim * 2, latent_dim, kernel_size=3, padding=1)
    ...
    def forward(self, x_t, t, input_latent, label_embed_id):
        ...
        h = self.conv3(h)
        return h  # Output is the predicted noise
