...
mlp_model = MLPModel(input_dim=32 * 4 * 4, label_num=num_labels, hidden_dim=1024, output_dim=32 * 4 * 4, num_res_blocks=2).to(device)
...
for epoch in range(nepoch):
    ...
    with torch.no_grad():
        ...
        data_logger["val_mse_loss"].append(val_loss)

    print("---Test---", "img_mse: ", val_loss, "patience: ",patience)
